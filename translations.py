...
TRANSLATIONS = {
    "en": {
        ...
        "register_button_link_text": "Don't have an account? Register",
        "recent_items_group": "Recent Items",
        ...
        "edit_spec_title": "Edit Specification",
        "edit_spec_prompt": "Enter the new value for the specification:",
        "add_spec_title": "Add Specification",
        "add_spec_prompt": "Enter the new specification in 'Key: Value' format:",
        ...
        "category_selection_title": "Select Categories",
        ...
        "print_queue_export_excel_button": "To Excel",
        "print_queue_print_list_button": "Print Item List",
        ...
        "spec_labels": {
            ...
            "Tempered Glass Side Panel": "Tempered Glass Side Panel",
            ...
            "Case Type": "Case Type",
            "Case Size": "Case Size",
            "PSU Included": "PSU Included",
            "Drive Bays": "Drive Bays",
            "Motherboard Size": "Motherboard Size",
            "Installed Coolers": "Installed Coolers",
            "Max Radiator Size": "Max Radiator Size",
            "Front I/O Ports": "Front I/O Ports",
            "Side Panel": "Side Panel",
            "Side Panel Type": "Side Panel Type",
            "Fans Included": "Fans Included",
            ...
            "Curved": "Curved",
            "Anti-Glare Coating": "Anti-Glare Coating",
            ...
            "AdobeRGB Coverage": "AdobeRGB Coverage",
            "DCI-P3 Coverage": "DCI-P3 Coverage",
            "HDR10": "HDR10",
            "Viewing Angle": "Viewing Angle",
            "Height Adjustment": "Height Adjustment",
            "Tilt Adjustment": "Tilt Adjustment",
            "Swivel Adjustment": "Swivel Adjustment",
            "Pivot Adjustment": "Pivot Adjustment",
            "Height Adjustable": "Height Adjustable",
            "Tilt Adjustable": "Tilt Adjustable",
            "Swivel Adjustable": "Swivel Adjustable",
            "Pivot Adjustable": "Pivot Adjustable",
    ...
    "ka": {
        ...
        "register_button_link_text": "არ გაქვთ ანგარიში? რეგისტრაცია",
        "recent_items_group": "ბოლოს ნანახი",
        ...
        "edit_spec_title": "მონაცემის რედაქტირება",
        "edit_spec_prompt": "შეიყვანეთ მონაცემის ახალი მნიშვნელობა:",
        "add_spec_title": "მონაცემის დამატება",
        "add_spec_prompt": "შეიყვანეთ ახალი მონაცემი 'დასახელება: მნიშვნელობა' ფორმატში:",
        ...
        "category_selection_title": "კატეგორიების არჩევა",
        ...
        "print_queue_export_excel_button": "ექსპორტი Excel-ში",
        "print_queue_print_list_button": "ნივთების სიის ამობეჭდვა",
        ...
        "spec_labels": {
            ...
            "TearingPreventionTechnology": "ანტი-დახევის ტექნოლოგია",
            ...
            # --- PC Case Specific ---
            "Motherboard Support": "დედაპლატის ზომები",
            "PSU Support": "კვების ბლოკის მხარდაჭერა",
            "Max GPU Length": "მაქს. GPU სიგრძე",
            "Max CPU Cooler Height": "მაქს. CPU გაგრილების სიმაღლე",
            "Radiator Support": "რადიატორის მხარდაჭერა",
            "Expansion Slots": "გაფართოების სლოტები",
            "Front Panel Connectors": "წინა პანელის კონექტორები",
            "Cable Management": "კაბელების მენეჯმენტი",
            "Tempered Glass Side Panel": "შუშის გვერდითი პანელი",
            "RGB Lighting": "RGB განათება",
            "Pre-Installed Fans": "დაყენებული ფენები",
            "Fan Support": "ფენების მხარდაჭერა",
            "Dust Filters": "მტვერის ფილტრები",
            "Case Type": "ქეისის ტიპი",
            "Case Size": "ქეისის ზომა",
            "PSU Included": "კვების ბლოკი შედის",
            "Drive Bays": "დისკის სლოტი",
            "Motherboard Size": "დედაპლატის ზომა",
            "Installed Coolers": "დაყენებული ფენები",
            "Max Radiator Size": "მაქს. რადიატორის ზომა",
            "Front I/O Ports": "წინა I/O პორტები",
            "Side Panel": "გვერდითი პანელი",
            "Side Panel Type": "გვერდითი პანელის ტიპი",
            "Fans Included": "დაყენებული ფენები",
            "Number of Fans": "ფენების რაოდენობა",
            "Fan Size": "ფენების ზომა",
            "Fan Speed": "ფენების სიჩქარე",
            "Max Fan Support": "მაქს. ფენების მხარდაჭერა",
            ...
            "Color Capability": "ფერთა შესაძლებლობა",
            ...
            "Ergonomic Stand": "ერგონომიული სტენდი",
            "Viewing Angles": "ხედვის კუთხეები",
            "Color Depth": "ფერთა სიღრმე",
            "HDR Support": "HDR-ის მხარდაჭერა",
            "Curved Screen": "გახრილი ეკრანი",
            "Curved": "გახრილი",
            "Anti-Glare Coating": "ანტისაწებო საფარი",
            "Anti-Glare": "ანტისაწებო",
            "Blue Light Filter": "ლურჯი შუქის ფილტრი",
            "Blue Light Reduction": "ლურჯი შუქის შემცირება",
            "Color Accuracy": "ფერთა სიზუსტე",
            "sRGB Coverage": "sRGB-ის დაფარვა",
            "AdobeRGB Coverage": "AdobeRGB-ის დაფარვა",
            "DCI-P3 Coverage": "DCI-P3-ის დაფარვა",
            "HDR10": "HDR10",
            "Viewing Angle": "ხედვის კუთხე",
            "Height Adjustment": "სიმაღლის რეგულირება",
            "Tilt Adjustment": "დახრის რეგულირება",
            "Swivel Adjustment": "ბრუნვის რეგულირება",
            "Pivot Adjustment": "პივოტის რეგულირება",
            "Height Adjustable": "სიმაღლის რეგულირებადი",
            "Tilt Adjustable": "დახრის რეგულირებადი",
            "Swivel Adjustable": "ბრუნვის რეგულირებადი",
            "Pivot Adjustable": "პივოტის რეგულირებადი",
